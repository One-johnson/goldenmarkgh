    ...
    <div className="page-shell">
      <div className="relative overflow-hidden bg-charcoal pb-10 pt-24 sm:pb-12 sm:pt-28 lg:pb-14 lg:pt-32">
        ...
        <div className="relative mx-auto max-w-6xl px-6 lg:px-8">
          ...
          <h1 className="mt-3 max-w-3xl font-display text-4xl font-semibold tracking-tight text-white sm:mt-4 sm:text-5xl lg:text-6xl">
            {data.title}
          </h1>
          <span aria-hidden className="gold-rule mt-5" />
          <p className="mt-5 max-w-3xl text-lg leading-relaxed text-stone-light sm:mt-6 sm:text-xl">
